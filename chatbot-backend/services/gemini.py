...
def generate_chat_response(messages: list) -> str:
    ...
    try:
        ...
        system_instruction = (
            "You are a smart financial assistant for MK Investors, a trusted financial advisor based in Madhavpur, Gujarat.\n\n"
            ...
            "- Refusal Style (Hinglish): 'Main MK Investors ka AI assistant hoon. Main aapki sirf finance, mutual funds, loans aur investment related questions me help kar sakta hoon. Please finance se related query puchein!'\n"
